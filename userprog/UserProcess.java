...
public class UserProcess {
    ...
    protected boolean loadSections() {
        ...
        for (int i=0; i<numPages; i++) {
            int physicalPage = UserKernel.assignPage();
           
            if (physicalPage < 0) {
                for (int j=0; j<i; j++) {
                    if (pageTable[j].valid) {
                        UserKernel.unassignPage(pageTable[j].ppn);
    ...
    private int create(int p1){
        ...
        OpenFile archivo = UserKernel.fileSystem.open(nombre, true);
        ...
        FileDescriptorTable.put(espacio, archivo);
    ...
    private int open(int p1){
        ...
        OpenFile archivo = UserKernel.fileSystem.open(nombre, false);
    ...
    private int read(int p1, int p2, int p3){
        if (!FileDescriptorTable.containsKey(p1) || p3 <= 0)
            return -1;
    ...
    private int unlink(int p1){
        ...
        return UserKernel.fileSystem.remove(nombre) ? 0 : -1;
    }
    ...
    //protected ArrayList FileDescriptorTable;
    protected HashMap<Integer,OpenFile> FileDescriptorTable;
    private static final int maxSize = 256, FDs = 16;
    ...
    private int argc, argv, contador=1;
